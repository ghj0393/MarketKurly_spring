...
<title>Insert title here</title>
	...
	<script src="${contextPath}/resources/js/11_itemlistformanager.js"></script>
</head>
<body>
		...
		<table border="1" style="border-collapse: collapse;">
			...
			<c:forEach var="item" items="${registeredItemList}">
				<tr height="50">
					...
					<td width="50" align="center">
						<button id="edit" name="${item.item_number}" onclick="edit(this)" style="color: black; background-color: white;">수정</button>
					<td width="50" align="center">
						<button id="del" name="${item.item_number}" onclick="del(this)" style="color: black; background-color: white;">삭제</button>
					</td>
				</tr>
			</c:forEach>
		</table>
